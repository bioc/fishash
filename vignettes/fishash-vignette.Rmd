...
particular with the target gene usually being knocked down (e.g. CPQ
guides have negative logFC for CPQ gene expression).  Some guides
should be investigated as outliers -- for example, the fourth PHF20L1
guide has different DEGs from the other PHF20L1 guides and in
particular fails to knockdown the PHF20L1 gene.
...
Beyond the scope of this vignette, a more detailed investigation could
potentially improve the calibration or power of the analysis, such as
by QC filtering of cells, by controlling for confounders (such as cell
state), or by improving estimates of the cell size factors or gene
overdispersions.
